...
public class jConfDia extends javax.swing.JInternalFrame {
    ...
    private void Imprimir(String dia, String dia2) {
...
//        String sSql = "SELECT conta, rgprp, rgimv, contrato, campo, dtvencimento, dtrecebimento, rc_aut FROM auxiliar WHERE Upper(conta) LIKE 'REC%' AND dtrecebimento = '&1.' ORDER BY rc_aut;";
        String sSql = "SELECT rgprp, rgimv, contrato, campo, dtvencimento, dtrecebimento, rc_aut FROM extrato WHERE dtrecebimento >= '&1.' AND dtrecebimento <= '&2.' ORDER BY contrato, dtvencimento;";
//        sSql = FuncoesGlobais.Subst(sSql, new String[] {Dates.DateFormata("yyyy-MM-dd", new Date())});
        sSql = FuncoesGlobais.Subst(sSql, new String[] {Dates.DateFormata("yyyy/MM/dd", Dates.StringtoDate(dia, "dd/MM/yyyy")), Dates.DateFormata("yyyy/MM/dd", Dates.StringtoDate(dia2, "dd/MM/yyyy"))});
...
//            }
    ...
    private void initComponents() {
        ...
        jDataFinal = new com.toedter.calendar.JDateChooser("dd/MM/yyyy", "##/##/#####", '_');
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jDataFinal, javax.swing.GroupLayout.PREFERRED_SIZE, 24, Short.MAX_VALUE))))
    ...
    private void jGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jGerarActionPerformed
        Imprimir(Dates.DateFormata("dd/MM/yyyy",jData.getDate()), Dates.DateFormata("dd/MM/yyyy",jDataFinal.getDate()));
