...
public class jSuperExtorno extends javax.swing.JInternalFrame {
    ...
    private boolean ExtornaExtratos(String nrAut) {
        ...
        try {
            ...
            String mRGPRP = "", sdant = "";
            try {
                mRGPRP = conn.LerCamposTabela(new String[] {"cx_rgprp"}, "caixabck", FuncoesGlobais.Subst("cx_doc = 'ET' AND cx_aut = '&1.'", new String[] {nrAut}))[0][3];
    ...
    private boolean Extornar(String nAut) {
        boolean bret = false;
        String sql = "SELECT * FROM caixabck WHERE cx_aut = &1.";
        sql = FuncoesGlobais.Subst(sql, new String[] {nAut});
