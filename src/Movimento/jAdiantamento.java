        ...
        for (int i=0;i<jRecibos.getRowCount();i++) {
            ...
            if (tag.equalsIgnoreCase("X")) {
                ...
                for (int nl=0; nl<linhas.length; nl++) {
                    ...
                    if (linhas[nl][0].toString().toLowerCase().contains("desc") && linhas[nl][3].equalsIgnoreCase("ET")) {
                        sCampos = FuncoesGlobais.ArraysAdd(sCampos, new String[] {linhas[nl][0].toString(),"0;;black","",new Pad(linhas[nl][2].toString(),12).LPad() + " "});                
                    }
                    if (linhas[nl][0].toString().toLowerCase().contains("dif") && linhas[nl][3].equalsIgnoreCase("ET")) {
                        sCampos = FuncoesGlobais.ArraysAdd(sCampos, new String[] {linhas[nl][0].toString(),"0;;black",new Pad(linhas[nl][2].toString(),12).LPad() + " ",""});                    
                    }
                }
        ...
        for (int i=0;i<jRecibos.getRowCount();i++) {
            ...
            if (tag.equalsIgnoreCase("X")) {
                ...
                for (int n=0; n<linhas.length; n++) {
                    ...
                    if (linhas[n][0].toString().toLowerCase().contains("desc") && linhas[n][3].toString().equalsIgnoreCase("ET")) {
                        corpo += new Pad(linhas[n][0].toString(),15).RPad() + "R$ " + new Pad(linhas[n][2].toString(),12).LPad() + "(+)\n";
                    }
                    if (linhas[n][0].toString().toLowerCase().contains("dif") && linhas[n][3].toString().equalsIgnoreCase("ET")) {
                        corpo += new Pad(linhas[n][0].toString(),15).RPad() + "R$ " + new Pad(linhas[n][2].toString(),12).LPad() + "(+)\n";
                    }
                }
