...
public class CentralPix extends javax.swing.JInternalFrame {
    ...
    private void LerBancosPix() {
        ...
        ResultSet imResult = this.conn.AbrirTabela(selectSql, ResultSet.CONCUR_READ_ONLY);
    ...
    private void initComponents() {
        ...
        jButton1.setText("Transmitir Lote");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabel7, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 598, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, 522, Short.MAX_VALUE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(ListaBancosPessoas, javax.swing.GroupLayout.PREFERRED_SIZE, 314, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jProgressEmail, javax.swing.GroupLayout.DEFAULT_SIZE, 218, Short.MAX_VALUE)
        ...
        jPanel11Layout.setVerticalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(pScroll, javax.swing.GroupLayout.PREFERRED_SIZE, 178, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Chave", "Lote", "id" }));
        ...
        jTabbedPaneBoletas.addTab("Consulta", jPanel7);
                ...
                if (p.getTag()) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            String outFileName = pathName + contrato + "_" + Bean1.getsacDadosNome() + "_" + vencto + "_" + Bean1.getpixNNumero() + ".pdf";
    ...
    public void EmDia() {
        ...
        try {
            ...
            while (rs.next()) {
                 ...
                 * Pega dados do Banco
                 */                
                String[][] Pix = PayLoad.LerBancoPIX(pixBanco.getSelectedItem().toString());
...
//            table.getColumnModel().getColumn(1).setMaxWidth(215);
    ...
    private ReciboPix CreateReciboPix(String rgprp, String rgimv, String contrato, String vencto, String dataBol) throws SQLException {
        ...
        payLoad.setPixKey(PixEmpresa(Pix[1][3]));
        payLoad.setDescription(gVar.get("recibo") + " Vencimento " + vencto);
        payLoad.setAmount(tRecibo);
        payLoad.setMerchantName(gVar.get("empresa").toUpperCase().trim());
