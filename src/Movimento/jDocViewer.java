...
public class jDocViewer extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tipo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Recibos", "Boletas", "Extratos", "Relatórios", "Boletas Digital" }));
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(null, java.awt.Color.darkGray), "( Enviar documento anexado por EMail )", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(0, 51, 153))); // NOI18N
    ...
    private void btPreviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPreviewActionPerformed
        ...
        if (docName.substring(docName.length() - 3, docName.length()).equalsIgnoreCase("PDF")) {
            ...
            new toPrint(docName, "THERMICA","TXT","EXTERNA");
        }
   ...
   public File[] listarArquivos(String caminhoDiretorio, final String extensao){  
    ...
    private void FillFiles() {
        if (tipo.getSelectedItem().equals("Recibos")) {
            ...
            tfiltro = (!bVersão.isSelected() ? "pdf" : "");
            FillPastas(pasta, tfiltro);
        } else if (tipo.getSelectedItem().equals("Boletas Digital")) {
