...
public class CentralBoletas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(ListaBancosPessoas, javax.swing.GroupLayout.PREFERRED_SIZE, 295, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jTabbedPaneBoletas, javax.swing.GroupLayout.PREFERRED_SIZE, 543, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
            ...
            if (!status.equalsIgnoreCase("OK")) {
                ...
                try {
                    if (!jSemEnvio.isSelected()) {
                        msg = new JEmail3(contrato, attachMent, edtSubJect.getText(), _htmlPane.getText().replaceAll("\n", "<br>"));
                    } else msg.setIsOK(true);
                ...
                tblEmails.getModel().setValueAt(msg.isIsOK() ? "Ok" : "Err", modelRow, 6);
            }
        }
            ...
            if (!status.equalsIgnoreCase("OK")) {
                ...
                try {
                    if (!jSemEnvio.isSelected()) {
                        ...
                        msg = new JEmail3(contrato, attachMent, edtSubJect.getText(), body);
...
//            table.getColumnModel().getColumn(1).setMaxWidth(215);
    ...
    private Boleta CreateBoleta(String rgprp, String rgimv, String contrato, String vencto, String dataBol) throws SQLException {
        ...
        if (innumero != 0) {
            ...
            bancos.GravarNnumero(bancos.getBanco(), String.valueOf(innumero));
        } else {
