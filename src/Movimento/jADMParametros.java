...
public class jADMParametros extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel56.setText("Tipoi:");

        pixTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Telefone", "Email", "CPF", "CNPJ", "Outros" }));
        ...
        jLabel57.setText("Chave:");

        jLabel58.setText("Banco:");
            ...
            .addGroup(jPanel24Layout.createSequentialGroup()
                ...
                .addGroup(jPanel24Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel24Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(pixChave)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel58)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(pixBanco, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel24Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel24Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(pixIncluir, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(pixExcluir, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jAbasCalculos, javax.swing.GroupLayout.PREFERRED_SIZE, 209, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void a_btdelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_a_btdelActionPerformed
            ...
            if (n == JOptionPane.YES_OPTION) {
                ...
                conn.Auditor("CONTAS ADM/DELETE", "CODIGO: " + tcodigo + " DESCR: " + tdescr);
    ...
    private void a_btsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_a_btsaveActionPerformed
        if (tag.equalsIgnoreCase("UPDATE")) {
            ...
            conn.Auditor("CONTAS ADM/UPDATE", "CODIGO: " + a_sigla.getText().trim() + " DESCR: " + a_desc.getText().trim());
        } else {
            ...
            try { 
                ...
                conn.Auditor("CONTAS ADM/INSERT", "CODIGO: " + a_sigla.getText().trim() + " DESCR: " + a_desc.getText().trim());
    ...
    private void pixExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pixExcluirActionPerformed
        ...
        int n = JOptionPane.showOptionDialog(null,
            ...
            "Aten̤̣o", JOptionPane.YES_NO_OPTION,
            JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
    ...
    private void bcoAdc() {
        ...
        conn.Auditor("BANCOS BOLETA/INSERT", "('" + tagencia + "','" +
                tconta + "','" + tcontadv + "','" + tnbanco + "','" + tnbancodv + "','" +
                tcarteira + "','" + tmoeda + "','" + ttarifa + "','" + tnnumero + "')");
    ...
    private void bcoDel() {
        ...
        if (pos > -1) {
            ...
            try { conn.ExecutarComando(sql); } catch (Exception e) {e.printStackTrace();}
            conn.Auditor("BANCOS BOLETA/DELETE", jtblBcos.getModel().getValueAt(pos, 4).toString().trim());
        }
        ListaContasBoletas();
    }
