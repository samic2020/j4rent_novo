...
public class jMultas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jExcluir, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        jlblPerGerComissao.setText("Percentual Geral de Comissáo");
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addComponent(jPercComissao, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void Excluir(String tipo) {
        ...
        if (tipo.equalsIgnoreCase("P")) {
            //Auditor
            conn.Auditor("MULTAS/EXCLUIR","PROPRIETARIO: : " + rgprp);
        } else if (tipo.equalsIgnoreCase("L")) {
            //Auditor
            conn.Auditor("MULTAS/EXCLUIR","LOC/IMOVEL: " + rgimv);
        }
    }
    ...
    private void LerGeral() throws SQLException {
        ...
        jlblPerGerComissao.setText("Percentual Geral de " + nmComissao);
    ...
    private void Gravar(String aonde) throws SQLException {
        ...
        if ("G".equals(aonde)) {
            String[][] aPar = {{"PA_MULTA","TEXTO",FuncoesGlobais.GravaValores(admmulta,3)},
                ...
                {"MULTADTGRAV","TEXTO", Dates.DateFormata("dd-MM-YYYY HH:mm:ss", dtGravacao)}
            };

            if (!conn.GravarMultiParametros(aPar)) {
                JOptionPane.showMessageDialog(null, "Nào foi possível realizar a gravação!!!\nTente novamente...", "Erro", JOptionPane.ERROR_MESSAGE);
            }
            conn.Auditor("MULTA: GERAL", "PA_MULTA: "  + FuncoesGlobais.GravaValores(admmulta,3) +
                ", PA_JUROS: " + FuncoesGlobais.GravaValores(admjuros,3) +
                ", PA_CORR: " + FuncoesGlobais.GravaValores(admcorrecao,3) +
                ", PA_TXEXP" + FuncoesGlobais.GravaValores(admexpediente,3) +
                ", MULTA_RES: " + FuncoesGlobais.GravaValores(multares,3) + 
                ", MULTA_COM: " + FuncoesGlobais.GravaValores(multacom,3) + 
                ", COR_TIPO: " + (CorSimples ? "0" : "1") +
                ", COR_LIM_SN: " + (corlim ? "1" : "0") +
                ", COR_LIM_A: " + FuncoesGlobais.GravaValores(corlima,0) +
                ", COR_CORR: " + FuncoesGlobais.GravaValores(corperc,3) +
                ", DIA_MUL: " + FuncoesGlobais.GravaValores(diasmulta,0) +
                ", DIA_COR: " + FuncoesGlobais.GravaValores(diascorrecao,0) +
                ", DIA_JUR: " + FuncoesGlobais.GravaValores(diasjuros,0) + 
                ", JUR_PER: " + FuncoesGlobais.GravaValores(jurosperc,3) +
                ", TE_PER: " + FuncoesGlobais.GravaValores(expperc,3) +
                ", TE_VRM: " + FuncoesGlobais.GravaValores(expminimo,2) +
                ", TXEXP: " + nmExpediente +
                ", COMISSAO: " + FuncoesGlobais.GravaValores(PercComissao,3) +
                ", JUROS: " + (PorMes ? "SIMPLES" : "COMPOSTO"));
            ...
            String[][] aPar = {{"PA_MULTA","TEXTO",FuncoesGlobais.GravaValores(admmulta,3)},
                ...
                {"DATAGRAVACAO","DATE",Dates.DateFormata("yyyy-MM-dd HH:mm:ss", dtGravacao)},
            ...
            if (!achei) {
                conn.Auditor("MULTA PROPRIETARIO INSERT",
                    "RGPRP: " + rgprp + 
                    ", PA_MULTA: "  + FuncoesGlobais.GravaValores(admmulta,3) +
                    ", PA_JUROS: " + FuncoesGlobais.GravaValores(admjuros,3) +
                    ", PA_CORR: " + FuncoesGlobais.GravaValores(admcorrecao,3) +
                    ", PA_TXEXP" + FuncoesGlobais.GravaValores(admexpediente,3) +
                    ", MULTA_RES: " + FuncoesGlobais.GravaValores(multares,3) + 
                    ", MULTA_COM: " + FuncoesGlobais.GravaValores(multacom,3) + 
                    ", COR_TIPO: " + (CorSimples ? "0000000000" : "0000000001") +
                    ", COR_LIM_SN: " + (corlim ? "1" : "0") +
                    ", COR_LIM_A: " + FuncoesGlobais.GravaValores(corlima,0) +
                    ", COR_CORR: " + FuncoesGlobais.GravaValores(corperc,3) +
                    ", DIA_MUL: " + FuncoesGlobais.GravaValores(diasmulta,0) +
                ...
                conn.Auditor("MULTA PROPRIETARIO UPDATE",
                    "RGPRP: " + rgprp +
                    ", PA_MULTA: "  + FuncoesGlobais.GravaValores(admmulta,3) +
                    ", PA_JUROS: " + FuncoesGlobais.GravaValores(admjuros,3) +
                    ", PA_CORR: " + FuncoesGlobais.GravaValores(admcorrecao,3) +
            ...
            if (!achei) {
                conn.Auditor("MULTA LOCA/IMOVEL INSERT",
                    "RGIMV: " + rgimv +
                    ", PA_MULTA: "  + FuncoesGlobais.GravaValores(admmulta,3) +
                    ", PA_JUROS: " + FuncoesGlobais.GravaValores(admjuros,3) +
                    ", PA_CORR: " + FuncoesGlobais.GravaValores(admcorrecao,3) +
                ...
                conn.Auditor("MULTA LOCA/IMOVEL UPDATE",
                    "RGIMV: " + rgimv +
                    ", PA_MULTA: "  + FuncoesGlobais.GravaValores(admmulta,3) +
                    ", PA_JUROS: " + FuncoesGlobais.GravaValores(admjuros,3) +
                    ", PA_CORR: " + FuncoesGlobais.GravaValores(admcorrecao,3) +
