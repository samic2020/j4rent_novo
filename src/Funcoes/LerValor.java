...
//        return Float.valueOf(newNumber);
       String retorno = "0.00";
        if (Valor != null) {
    ...
    static public String FloatToString(float Valor) {
        ...
        String part1 = newNumber.substring(0,newNumber.indexOf(","));
        String part2 = newNumber.substring(newNumber.indexOf(",")+1) + "00";
        return part1 + "," + part2.substring(0, 2);
    }
    ...
    static public String doubleToCurrency(double cValor, int decimal) {
        DecimalFormat v = new DecimalFormat();
        if (decimal > 0) {
            v.applyPattern("#,##0." + FuncoesGlobais.StrZero("0", decimal));
        } else {
    ...
    static public String FormatNumber2(String cValor, int decimal) {
        String Inteiro;
        String Decimal;
