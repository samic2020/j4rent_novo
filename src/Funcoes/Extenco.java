...
public class Extenco {
    ...
    public Extenco() { nro = new ArrayList<Integer>(); }
     ...
     */
    public Extenco(BigDecimal dec) throws NumberFormatException {
        this();
        setNumber(dec);
    }
     ...
     *            Valor para colocar por extenso.
     */
    public Extenco(double dec) throws NumberFormatException {
        this();
        setNumber(dec);
    }
