...
public class Settings {
    static private String GlobalPropert = System.getProperty("user.dir") + "/j4Rent.conf";
    ...
    public Settings() {
        ...
        if (osname.equalsIgnoreCase("LINUX") || osname.equalsIgnoreCase("MAC")) {
            localPropert = System.getProperty("user.home") + "/j4Rent.conf";
        } else {
            localPropert = "C://j4Rent.conf";
        }
    ...
    public void Save(String propriedade, String Valor) {
        try {
            ...
            p.store(outFile,"j4Rent.propriedades");
            outFile.close();
        } catch (Exception ex) {ex.printStackTrace();}
    }
