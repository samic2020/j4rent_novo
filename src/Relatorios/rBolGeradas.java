 ...
 * @author supervisor
 */
public class rBolGeradas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle(".:: Relatório de Boletas Geradas ::.");
        setVisible(true);
    ...
    private void RelRecAtr(String dtInic, String dtFinal) {
        ...
        try {
            String fileName = "reports/RelBoletasImp.jasper";
            ...
            String outFileName = "reports/Relatorios/RelBoletasImp_" + Dates.DateFormata("ddMMyyyy", new Date()) + ".pdf";
