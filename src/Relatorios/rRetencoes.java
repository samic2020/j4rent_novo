...
public class rRetencoes extends javax.swing.JInternalFrame {
    ...
    private void FillLike() {
        ...
        jLIKE.addItem("%");
        if (!sql.isEmpty()) {
            ResultSet imResult = this.conn.AbrirTabela(sql, ResultSet.CONCUR_READ_ONLY);
    ...
    private void ListaRetencao(Boolean bPagas, Date dInic, Date dFinal, String dLike) {
        ...
        try {
            while (rs.next()) {
                ...
                String[][] adados = conn.LerCamposTabela(new String[] {"dtrecebimento"}, "extrato", "rc_aut = '" + drcaut + "'");
                String drecebimento = null; Date drecbto = null;
                if (adados != null) {
                    drecebimento = Dates.DateFormata("dd/MM/yyyy", Dates.StringtoDate(adados[0][3], "yyyy/MM/dd"));
