 ...
 * @author supervisor
 */
public class rRecTaxaBancaria extends javax.swing.JInternalFrame {
    DbMain conn = VariaveisGlobais.conexao;

    /** Creates new form rSeguros */
    public rRecTaxaBancaria() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle(".:: Relatório de Taxa Bancaria ... ::.");
        setVisible(true);
    ...
    private void RelTxBanc(String dtInic, String dtFinal) {
        Collections gVar = VariaveisGlobais.dCliente;
        
        Map parametros = new HashMap();
        parametros.put("dtinic", Dates.StringtoDate(dtInic,"yyyy/MM/dd"));
        parametros.put("dtfim", Dates.StringtoDate(dtFinal,"yyyy/MM/dd"));
        
        try {
            String fileName = "reports/RelTarifaBancaria.jasper";
            ...
            String outFileName = "reports/Relatorios/TarifaBancaria_" + Dates.DateFormata("ddMMyyyy", new Date()) + ".pdf";
