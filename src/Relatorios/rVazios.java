...
public class rVazios extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        pAtivos.setBackground(new java.awt.Color(254, 254, 254));
        ...
        pInativos.setBackground(new java.awt.Color(254, 254, 254));
        ...
        iAlugados.setBackground(new java.awt.Color(254, 254, 254));
        ...
        iVazios.setBackground(new java.awt.Color(254, 254, 254));
    ...
    private void ShowEstatisticas() {
        ...
        ResultSet tmp = conn.AbrirTabela(sql, ResultSet.CONCUR_READ_ONLY);
        try {
            while (tmp.next()) {
                tivazios = tmp.getFloat("ivazios");
            }
        } catch (Exception err) {}
        DbMain.FecharTabela(tmp);
        ...
        tmp = conn.AbrirTabela(sql, ResultSet.CONCUR_READ_ONLY);
        try {
            while (tmp.next()) {
