 ...
 * jNewImovel.java
 *
 * Created on 11/12/2011, 18:19:33
 */
...
public class jImovel extends javax.swing.JDialog {
    ...
    ResultSet pResult = conn.AbrirTabela("SELECT * FROM imoveis ORDER BY rgprp, rgimv;", ResultSet.CONCUR_UPDATABLE);
    ...
    private String LerLegendas() {
        ResultSet lg = conn.AbrirTabela("SELECT CART_CODIGO, CART_DESCR FROM LANCART WHERE CART_TAXA = '1' ORDER BY CART_CODIGO;", ResultSet.CONCUR_READ_ONLY);
    ...
    private void jbtBaixarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtBaixarActionPerformed
        ...
        if (VariaveisGlobais.situacao.equalsIgnoreCase("VAZIO")) {
            ...
            conn.ExecutarComando("UPDATE locatarios set fiador1uf = 'X' WHERE rgimv = '"  + iRgimv.getText() + "';");
            ...
            if (dados_carteira != null) {
                ...
                conn.ExecutarComando(auxSql);
            }
            conn.ExecutarComando("DELETE FROM CARTEIRA WHERE rgimv = '" + iRgimv.getText() + "';");
        }
    ...
    private void iBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_iBtExcluirActionPerformed
        ...
        if (n == JOptionPane.YES_OPTION) {
            sql = new String[] {
                "INSERT INTO `jgeral_excluidos`.`auxiliar` SELECT * FROM `jgeral`.`auxiliar` WHERE rgimv = '" + iRgimv.getText() + "';",
                "DELETE FROM `jgeral`.`auxiliar` WHERE rgimv = '" + iRgimv.getText() + "';",
                
                "INSERT INTO `jgeral_excluidos`.`avisos` SELECT * FROM `jgeral`.`avisos` WHERE registro = '" + iRgimv.getText() + "';",
                "DELETE FROM `jgeral`.`avisos` WHERE registro = '" + iRgimv.getText() + "';",

                "INSERT INTO `jgeral_excluidos`.`caixa` SELECT * FROM `jgeral`.`caixa` WHERE cx_rgimv = '" + iRgimv.getText() + "';",
                "DELETE FROM `jgeral`.`caixa` WHERE cx_rgimv = '" + iRgimv.getText() + "';",
                
                "INSERT INTO `jgeral_excluidos`.`caixabck` SELECT * FROM `jgeral`.`caixabck` WHERE cx_rgimv = '" + iRgimv.getText() + "';",
                "DELETE FROM `jgeral`.`caixabck` WHERE cx_rgimv = '" + iRgimv.getText() + "';",
                
                "INSERT INTO `jgeral_excluidos`.`carteira` SELECT * FROM `jgeral`.`carteira` WHERE rgimv = '" + iRgimv.getText() + "';",
                "DELETE FROM `jgeral`.`carteira` WHERE rgimv = '" + iRgimv.getText() + "';",
                
                "INSERT INTO `jgeral_excluidos`.`descontos` SELECT * FROM `jgeral`.`descontos` WHERE rgimv = '" + iRgimv.getText() + "';",
                "DELETE FROM `jgeral`.`descontos` WHERE rgimv = '" + iRgimv.getText() + "';",
                
                "INSERT INTO `jgeral_excluidos`.`diferenca` SELECT * FROM `jgeral`.`diferenca` WHERE rgimv = '" + iRgimv.getText() + "';",
                "DELETE FROM `jgeral`.`diferenca` WHERE rgimv = '" + iRgimv.getText() + "';",

                "INSERT INTO `jgeral_excluidos`.`divisao` SELECT * FROM `jgeral`.`divisao` WHERE rgimv = '" + iRgimv.getText() + "';",
                "DELETE FROM `jgeral`.`divisao` WHERE rgimv = '" + iRgimv.getText() + "';",

                "INSERT INTO `jgeral_excluidos`.`extrato` SELECT * FROM `jgeral`.`extrato` WHERE rgimv = '" + iRgimv.getText() + "';",
                "DELETE FROM `jgeral`.`extrato` WHERE rgimv = '" + iRgimv.getText() + "';",

                "INSERT INTO `jgeral_excluidos`.`fiadores` SELECT * FROM `jgeral`.`fiadores` WHERE rgimv = '" + iRgimv.getText() + "';",
                "DELETE FROM `jgeral`.`fiadores` WHERE rgimv = '" + iRgimv.getText() + "';",

                "INSERT INTO `jgeral_excluidos`.`imoveis` SELECT * FROM `jgeral`.`imoveis` WHERE rgimv = '" + iRgimv.getText() + "';",
                "DELETE FROM `jgeral`.`imoveis` WHERE rgimv = '" + iRgimv.getText() + "';",

                "INSERT INTO `jgeral_excluidos`.`locatarios` SELECT * FROM `jgeral`.`locatarios` WHERE rgimv = '" + iRgimv.getText() + "';",
                "DELETE FROM `jgeral`.`locatarios` WHERE rgimv = '" + iRgimv.getText() + "';",

                "INSERT INTO `jgeral_excluidos`.`multa` SELECT * FROM `jgeral`.`multa` WHERE rgimv = '" + iRgimv.getText() + "';",
                "DELETE FROM `jgeral`.`multa` WHERE rgimv = '" + iRgimv.getText() + "';",

                "INSERT INTO `jgeral_excluidos`.`recibo` SELECT * FROM `jgeral`.`recibo` WHERE rgimv = '" + iRgimv.getText() + "';",
                "DELETE FROM `jgeral`.`recibo` WHERE rgimv = '" + iRgimv.getText() + "';",

                "INSERT INTO `jgeral_excluidos`.`retencao` SELECT * FROM `jgeral`.`retencao` WHERE rgimv = '" + iRgimv.getText() + "';",
                "DELETE FROM `jgeral`.`retencao` WHERE rgimv = '" + iRgimv.getText() + "';",

                "INSERT INTO `jgeral_excluidos`.`seguros` SELECT * FROM `jgeral`.`seguros` WHERE rgimv = '" + iRgimv.getText() + "';",
                "DELETE FROM `jgeral`.`seguros` WHERE rgimv = '" + iRgimv.getText() + "';"
            };
...
//        }
    ...
    private void ifoto_adcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ifoto_adcActionPerformed
        String[][] img = null; String nmImagem = "";
        try { img = conn.LerCamposTabela(new String[] {"fotos"}, "imoveis", "rgimv = '" + VariaveisGlobais.rgimv + "'");} catch (Exception e) {}
        if (img != null) {
            if (img[0][3] != null) {
                if  (!img[0][3].equalsIgnoreCase("")) {
        ...
        if (new File("fotos/" + nmImagem + ".jpg").exists()) {
            try {MontaCampos(nmImagem,img[0][3].split(";").length);} catch (Exception e) {}
        }
    ...
    */
    ...
    private void GravarDados() throws SQLException {
        ...
        if (bNew) {
            int NewRgImv = 0;
            try {
                NewRgImv = Integer.parseInt(conn.LerParametros("PROP" + VariaveisGlobais.rgprp.trim()));
            } catch (SQLException ex) {
                NewRgImv = 0;
        ...
        if (bNew) {
            ...
            pResult.updateInt("rgprp", Integer.parseInt(VariaveisGlobais.rgprp));
            pResult.updateInt("rgimv", Integer.parseInt(VariaveisGlobais.rgprp) + iNewRgImv);

            iRgimv.setText(Integer.toString(Integer.parseInt(VariaveisGlobais.rgprp) + iNewRgImv));
        }

        pResult.updateString("tpimovel", iTipoImv.getSelectedItem().toString());
        pResult.updateString("tpurbrural", iUrbRural.getSelectedItem().toString());
        pResult.updateString("situacao",iSituacao.getModel().getSelectedItem().toString());
        pResult.updateString("end",iEndereco.getText());
        pResult.updateString("num", iNumero.getText());
        pResult.updateString("compl",iCplto.getText());
        pResult.updateString("bairro",iBairro.getText());
        pResult.updateString("cidade", iCidade.getText());
        pResult.updateString("codcid", iCodCidade.getText());
        pResult.updateString("estado", iEstado.getText().toUpperCase());
        pResult.updateString("cep", iCep.getText());

        pResult.updateString("especifica", iDescricao.getText());
        pResult.updateString("menssagem", iMsg.getText());
        pResult.updateString("obs", iObs.getText());
        
        // atuzlização de 07/07/2014
        try {
            pResult.updateBoolean("reter", iReter.isSelected());
            String matriculas = FuncoesGlobais.join(FuncoesGlobais.ComboLista(iMatriculas),";");
            if (!matriculas.isEmpty()) pResult.updateString("matriculas", matriculas); else pResult.updateString("matriculas", null);
            pResult.updateString("fotos", ListaFotos());
        ...
        if (!bNew) {
            if (iSituacao.getModel().getSelectedItem().toString().toUpperCase().equalsIgnoreCase("AÇÃO")) {
                ...
                ResultSet dbRecibos = conn.AbrirTabela("SELECT * FROM RECIBO r WHERE r.rgprp = '" + VariaveisGlobais.rgprp + "' AND r.rgimv = '" + iNewRgImv + "' AND r.tag <> 'X' ORDER BY r.dtvencimento;", ResultSet.CONCUR_READ_ONLY);
                ...
                ResultSet dbCarteira = conn.AbrirTabela("SELECT dtinicio FROM CARTEIRA WHERE contrato = '" + sContrato + "';", ResultSet.CONCUR_READ_ONLY);
                ...
                DbMain.FecharTabela(dbCarteira);
                ...
                ResultSet dbDados = conn.AbrirTabela("SELECT p.rgprp, p.nome, p.cpfcnpj, i.rgimv, i.`end` as ende, i.`num` as numero, i.compl, i.bairro, i.cidade, i.estado, i.cep, l.contrato, l.nomerazao, l.cpfcnpj FROM proprietarios p, imoveis i, locatarios l WHERE p.rgprp = i.rgprp and i.rgimv = l.rgimv and l.contrato = '" + sContrato + "';", ResultSet.CONCUR_READ_ONLY);
                ...
                if (filler.Open()) {
                    ...
                    dbRecibos = conn.AbrirTabela("SELECT * FROM RECIBO r WHERE r.rgprp = '" + prgprp + "' AND r.rgimv = '" + irgimv + "' AND r.contrato = '" + lcontrato + "' AND r.tag <> 'X' ORDER BY r.dtvencimento;", ResultSet.CONCUR_READ_ONLY);
