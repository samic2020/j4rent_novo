 ...
 * @author supervisor
 */
public final class jCarteiraPre extends javax.swing.JDialog {
    ...
    public jCarteiraPre(java.awt.Frame parent, boolean modal) throws SQLException, ParseException {
        super(parent, modal);
        initComponents();
    ...
    public jCarteiraPre(String lContrato, java.awt.Frame parent, boolean modal) throws SQLException, ParseException {
        super(parent, modal);
        initComponents();
        ...
        jPnlDadosLayout.setHorizontalGroup(
            ...
            .addGroup(jPnlDadosLayout.createSequentialGroup()
                ...
                .addGroup(jPnlDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jDtAdito, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jScroll, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 628, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(jPnlDados, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScroll, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private boolean GravarCampos() {
        ...
        if ("".equals(smsg)) { 
            String SQLtxt = "UPDATE PRECARTEIRA SET DTINICIO = '" + gDtInicio + "', CAMPO = '" + fCampos + "', DTTERMINO = '" +
    ...
    public boolean InsereCampos() throws SQLException {
        ...
        sqlSelect = "SELECT CART_CODIGO, " +
                  "CART_DESCR, CART_ORDEM, CART_CONTEUDO, " +
                  "CART_COTPAR, CART_TAXA, CART_FEDERAL, CART_MODIFICA, " +
                  "CART_FIXO, CART_RETENCAO, CART_RECIBO, " +
                  "CART_EXTRATO, CART_IMPOSTO, CART_ANTECIPA FROM LANCART " + sqlWhere;
        ...
        if (!"".equals(cartCampos.trim())) {
            ...
            if (!mCartVazio)
                mSql = "UPDATE PRECARTEIRA SET CAMPO = '" + stCAMPOS + "' WHERE CONTRATO = '" + this.mContrato + "';";

            else {
                String[][] vCampos = conn.LerCamposTabela(new String[] {"rgprp", "rgimv", "contrato"}, "prelocatarios", "contrato = '" + this.mContrato + "'");
                String rgprp = vCampos[0][3];
                String rgimv = vCampos[1][3];
                String contrato = vCampos[2][3];

                mSql = "INSERT INTO PRECARTEIRA (rgprp,rgimv,contrato,campo) " +
    ...
    public void MontaTela() throws SQLException {
        ...
        String sql = "SELECT * FROM PRECARTEIRA WHERE contrato = '" + this.mContrato + "';";
        DbMain conn = VariaveisGlobais.conexao;
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jCarteiraPre dialog = null;
                try {
                    try {
                        dialog = new jCarteiraPre(new javax.swing.JFrame(), true);
                    } catch (ParseException ex) {
                        ex.printStackTrace();
                    }
                } catch (SQLException ex) {
