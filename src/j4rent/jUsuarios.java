...
public class jUsuarios extends javax.swing.JInternalFrame {
    ...
    boolean isnew = false;
    ResultSet urs = conn.AbrirTabela("SELECT u.f_cod, u.f_nome, u.f_funcao, u.f_cpf, " +
              "u.f_rg, u.f_ctps, u.f_end, u.f_bai, u.f_cid, u.f_est, u.f_cep, u.f_tel, " +
              "u.f_cont, u.usuario, u.senha FROM cadfun u ORDER BY Upper(u.f_nome);", ResultSet.TYPE_SCROLL_INSENSITIVE);
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(btIncluir, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        pnloginLayout.setHorizontalGroup(
            ...
            .addGroup(pnloginLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(mSenha, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private String checacampostela(boolean Novo) {
        ...
        if (Novo && mCpf.getText().trim().replace(".", "").replace("-", "").length() > 0) {
            String[][] jaexiste = null;
            try {jaexiste = conn.LerCamposTabela(new String[] {"f_cpf"}, "cadfun", "f_cpf = '" + mCpf.getText().trim() + "'");} catch (Exception e) {}
    ...
    private void SaveFields(boolean save) {
        ...
        if (save) {
            try {
                tficha = String.valueOf(Integer.valueOf(conn.LerParametros("codfun")) + 1).replace(".0", "");
                conn.GravarParametros(new String[] {"codfun",tficha,"NUMERICO"});
            } catch (Exception e) {}
        ...
        DbMain.FecharTabela(urs);
        urs = conn.AbrirTabela("SELECT u.f_cod, u.f_nome, u.f_funcao, u.f_cpf, " +
                      "u.f_rg, u.f_ctps, u.f_end, u.f_bai, u.f_cid, u.f_est, u.f_cep, u.f_tel, " +
                      "u.f_cont, u.usuario, u.senha FROM cadfun u ORDER BY Upper(u.f_nome);", ResultSet.TYPE_SCROLL_INSENSITIVE);        
